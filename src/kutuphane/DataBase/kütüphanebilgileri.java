 ...
 * @author meren
 */
public class kütüphanebilgileri extends javax.swing.JFrame {
        
    /**
     * Creates new form adminpaneli
     */
    public kütüphanebilgileri() {
        initComponents();
        this.setResizable(false);
        KullanıcıManager kullanıcıManager = new KullanıcıManager();
        DatabaseManager databaseManager = new DatabaseManager();
        BookRepository book=new BookRepository(databaseManager);
        String loggedInUsername = kullanıcıManager.getLoggedInUsername();
        kullanıcıadı1.setText(loggedInUsername);
        int kitap= book.getNumberOfBooks();
        kitapsayisi.setText(String.valueOf(kitap));
        UserRepository user=new UserRepository(databaseManager);
        int kullanici=user.numberOfUser();
        kullanicisayisi.setText(String.valueOf(kullanici));
    ...
    private void initComponents() {
        ...
        kullanıcıadı1 = new javax.swing.JTextPane();
        ...
        kitapsayisi = new javax.swing.JTextPane();
        jScrollPane3 = new javax.swing.JScrollPane();
        kullanicisayisi = new javax.swing.JTextPane();
        ...
        jScrollPane5.setViewportView(kullanıcıadı1);

        jPanel1.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, 80, -1));
        ...
        jLabel5.setText("Kütüphane Bilgileri");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 190, 60));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("Bu Uygulama Kırklareli  Üniversitesi Öğrencilerinin kütüphane\n içerisindeki  kitaplarla ilgili bilgi alması için oluşturulmuştur.\nİletişim:\nMuhammed Eren Yüksel:m.eren003@hotmail.com\nSami Yetişken:samiyetisken@gmail.com");
        jScrollPane1.setViewportView(jTextArea1);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 260, 420, 260));
        ...
        jLabel4.setText("Kullanıcı Sayısı");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 20, 140, 50));

        jLabel3.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Kitap Sayısı");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 20, 130, 50));

        kitapsayisi.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        kitapsayisi.setToolTipText("");
        jScrollPane2.setViewportView(kitapsayisi);

        jPanel3.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 80, 110, 70));

        kullanicisayisi.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jScrollPane3.setViewportView(kullanicisayisi);

        jPanel3.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 80, 150, 70));

        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 470, 180));
    ...
    private void kitapayarlarıActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kitapayarlarıActionPerformed
        Kitapayarları kitap = new Kitapayarları();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kütüphanebilgileri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kütüphanebilgileri().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextPane kitapsayisi;
    private javax.swing.JTextPane kullanicisayisi;
    private javax.swing.JTextPane kullanıcıadı1;
