...
public class kullanıcıekle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(Kullanıcıekle, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 420, 190, 70));
        ...
        jPanel2.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 310, 140, 30));
...
if (control == 0 || isim.getText().equals("") || soyisim.getText().equals("") || kullanıcıadi.getText().equals("") || şifre.getText().equals("")) {
    ...
    // Eğer ünvan "admin" ise, kullanıcıyı "admins" tablosuna da ekle
    if (secilenUnvan.equalsIgnoreCase("Admin")) {
        AdminManager adminManager = new AdminManager(); 
        adminManager.Admininsert(isim.getText().toUpperCase(), soyisim.getText().toUpperCase(), kullanıcıadi.getText(), şifre.getText(), secilenUnvan);
    }

    // Diğer kullanıcıyı genel tabloya ekle
    usersManager.insert(isim.getText().toUpperCase(), soyisim.getText().toUpperCase(), kullanıcıadi.getText(), şifre.getText(), secilenUnvan);
