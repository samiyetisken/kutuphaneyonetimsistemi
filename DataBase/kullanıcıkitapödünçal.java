 ...
 * @author meren
 */
public class kullanıcıkitapödünçal extends javax.swing.JFrame {

    /**
     * Creates new form adminpaneli
     */
    public kullanıcıkitapödünçal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        kullanıcıadıödünçal = new javax.swing.JTextField();
        ...
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 350, 110, 40));

        kitapödünçalbutton.setText("Kitap Ödünç Al");
        jPanel2.add(kitapödünçalbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 440, 110, 40));

        kullanıcıadıödünçal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kullanıcıadıödünçalActionPerformed(evt);
            }
        });
        jPanel2.add(kullanıcıadıödünçal, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, 170, 40));
        ...
        jPanel2.add(yazaradı, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 350, 170, 40));

        jLabel4.setFont(new java.awt.Font("Georgia", 1, 16)); // NOI18N
        jLabel4.setText("Kullanıcı Adı");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 250, 110, 40));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/kutuphane/DataBase/kitapödünçalresim.jpg"))); // NOI18N
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 50, 170, 170));

        jLabel6.setFont(new java.awt.Font("Georgia", 1, 16)); // NOI18N
        jLabel6.setText("Kitap Adı");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 300, 110, 40));
        ...
        jPanel2.add(kitapadı1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 300, 170, 40));
    ...
    private void kullanıcıadıödünçalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kullanıcıadıödünçalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_kullanıcıadıödünçalActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kullanıcıkitapödünçal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kullanıcıkitapödünçal().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField kullanıcıadıödünçal;
