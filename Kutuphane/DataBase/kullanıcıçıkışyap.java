 ...
 * @author meren
 */
public class kullanıcıçıkışyap extends javax.swing.JFrame {

    /**
     * Creates new form adminpaneli
     */
    public kullanıcıçıkışyap() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Çıkış yapmak istediğinize emin misiniz?");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 20, 330, 210));

        hayır.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        hayır.setText("Hayır");
        hayır.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                hayırActionPerformed(evt);
            }
        });
        jPanel4.add(hayır, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 210, 130, 40));

        evet.setFont(new java.awt.Font("Georgia", 1, 14)); // NOI18N
        evet.setText("Evet");
        jPanel4.add(evet, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 210, 130, 40));

        jPanel2.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, 450, 270));
    ...
    private void hayırActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hayırActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_hayırActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kullanıcıçıkışyap.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new kullanıcıçıkışyap().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton hayır;
