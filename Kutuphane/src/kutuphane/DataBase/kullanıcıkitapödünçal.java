...
public class kullanıcıkitapödünçal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        kitapödünçalbutton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kitapödünçalbuttonActionPerformed(evt);
            }
        });
        jPanel2.add(kitapödünçalbutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 330, 110, 40));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 250, 110, 40));
        ...
        jPanel2.add(kitapadı1, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, 170, 40));
    ...
    private void kitaplarımActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kitaplarımActionPerformed
        kullanıcıkitaplarım kitaplarim = new kullanıcıkitaplarım();
    ...
    private void kitapödünçalbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kitapödünçalbuttonActionPerformed
        String kitapAdi = kitapadı1.getText().trim();

    if (!kitapAdi.isEmpty()) {
        BorrowKitapManager borrowKitapManager = new BorrowKitapManager();

        // Kitap ödünç alınabilir mi kontrol et
        borrowKitapManager.borrowBook(kitapAdi);

        // Bildirim göster
        
        borrowKitapManager.bildirim(kullanıcıadı.getText(), kitapAdi);
        // Kullanıcıya mesaj göster
        JOptionPane.showMessageDialog(this, "Kitap başarıyla ödünç alındı.");
    } else {
        JOptionPane.showMessageDialog(this, "Lütfen bir kitap adı girin.");
    }
    }//GEN-LAST:event_kitapödünçalbuttonActionPerformed
