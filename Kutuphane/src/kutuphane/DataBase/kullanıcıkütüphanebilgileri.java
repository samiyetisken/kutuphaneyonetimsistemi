...
public class kullanıcıkütüphanebilgileri extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane3.setViewportView(kitapsayisi);

        jPanel3.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 90, 110, 60));

        kullanicisayisi.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jScrollPane4.setViewportView(kullanicisayisi);

        jPanel3.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, 150, 60));
