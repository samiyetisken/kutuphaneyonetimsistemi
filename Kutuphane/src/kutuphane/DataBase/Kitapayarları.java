 ...
 * @author meren
 */
public class Kitapayarları extends javax.swing.JFrame {

    /**
     * Creates new form adminpaneli
     */
    public Kitapayarları() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Kitap Ekle");
        jLabel3.setAutoscrolls(true);
        jLabel3.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, 130, 40));

        jLabel5.setFont(new java.awt.Font("Georgia", 1, 18)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("Kitap Bilgilerini Güncelle");
        ...
        jPanel2.add(kitapekle, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 220, 190, 70));
        ...
        jPanel2.add(kitapgüncelle, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 370, 190, 70));
        ...
        jPanel2.add(kitapsil, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 90, 190, 70));
    ...
    private void kullanıcıayarlarıActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kullanıcıayarlarıActionPerformed
        kullanıcıayarları kullanıcıayar = new kullanıcıayarları();
        kullanıcıayar.setVisible(true);
        this.dispose();
    ...
    private void kitapgüncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kitapgüncelleActionPerformed
        kitapgüncelle güncelle = new kitapgüncelle();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kitapayarları.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kitapayarları().setVisible(true);
            }
        });
    }
