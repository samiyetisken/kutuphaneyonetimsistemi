...
public class kullanıcısil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(kullanıcıadi, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 110, 200, 40));
        ...
        jPanel2.add(Kullanıcısil, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 200, 190, 70));
    ...
    private void KullanıcısilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KullanıcısilActionPerformed
       KullanıcıManager userManager = new KullanıcıManager();
         userManager.delete(kullanıcıadi.getText().toUpperCase());
